...
;(function($) {
    $.omWidget('om.omGrid', {
         ...
         * @name omGrid#setData
         * @function
         * @param jsonObj JSON数组
         * 使用JSON数组对象来设置表格中的行数据
         */
        setRowData:function(jsonObj){
        	var pageData=this.pageData;
        	if(pageData==undefined )pageData = {nowPage:1,totalPages:1};
        	if(pageData.data==undefined) pageData.data={rows:[],total:0}
        	pageData.data.rows=jsonObj;
        	this._addData(pageData)
        	alert("223333");
        },
        /**
         * 获取表格JSON数据。<br/>
