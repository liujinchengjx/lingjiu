...
/**
 *   费用变量配置 配置一些在计算的时候有变化的变量值 (客户独享)
 * @author li
 */
@Entity
@Table(name = "customer_charges_variables")
public class CustomerChargesVariables extends BaseBean{	
	...
	private String variableName;//费用变量名
